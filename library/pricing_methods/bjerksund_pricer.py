...
class BjerksundStensland:
    ...
    def _beta(self):
        term = ((self.b / self.sigma**2 - 0.5)**2 + 2 * self.r / self.sigma**2)
...
class BjerksundPricer:
    """
    Pricer for American options using the in-file Bjerksund-Stensland model.
    """
    ...
    def price(self,
        ...
        """
        # Unpack single-asset params
        S0 = params.spot[0]
        sigma = params.sigma[0]
        q = params.dividend_yield[0]
        r = params.rf_rate
        T = params.maturity
